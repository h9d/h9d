...
class H9FrameComparator {
  private:
    constexpr static std::uint16_t SOURCE_ID = 1;
    constexpr static std::uint16_t BROADCAST_GROUP = 2;
  ...
  public:
    ...
    void set_source_id(std::uint8_t source_id_v);
    void set_broadcast_group(std::uint16_t broadcast_group_v);
