...
void H9FrameComparator::set_source_id(std::uint8_t source_id_v) {
    source_id = source_id_v;
    fields_to_compare |= H9FrameComparator::SOURCE_ID;
}

void H9FrameComparator::set_broadcast_group(std::uint16_t broadcast_group_v) {
    broadcast_group = broadcast_group_v;
...
void H9FrameComparator::set_destination_id(std::uint8_t destination_id_v) {
    destination_id_set1 = destination_id_v;
    fields_to_compare |= H9FrameComparator::DESTINATION_ID_SET1;
}

void H9FrameComparator::set_destination_id_in_alternate_set(std::uint8_t destination_id_v) {
